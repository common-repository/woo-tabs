...
function woo_tabs_load_plugin_textdomain() {
  load_plugin_textdomain( 'woo-tabs', FALSE, basename( dirname( __FILE__ ) ) . '/languages/' );
}
add_action( 'plugins_loaded', 'woo_tabs_load_plugin_textdomain' );